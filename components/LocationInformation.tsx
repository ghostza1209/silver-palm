...
export default function LocationInFormation() {
  return (
    <div className="relative overflow-hidden w-full">
      <div className="pt-10">
        <div className="flex flex-row relative mx-auto max-w-7xl px-4">
          <div className="w-[50%] pr-5">
            ...
            <p className="mt-4 text-base text-gray-500">
              ...
              subdistrict — one of the most prestigious and exclusive
              residential areas on the island. Careful consideration was taken
              in selecting this location, which is not only centrally located on
              the island, but strikes a strategic balance in favor of access to
              the airport, the finest shopping and dining, schools,
              entertainment, and, of course, beaches.
            </p>
            ...
            <div className="text-gray-500">
              ...
              <p>
                Laguna Golf Course{" "}
                <span className="text-amber-500">12.2 km</span>
              </p>
              <p>
